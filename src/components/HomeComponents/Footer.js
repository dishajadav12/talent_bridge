      ...
      <div className="footer-container">
        <footer>
          ...
          <div className="d-flex justify-content-center">
            ...
            <a className="footer-links" href="/channels">
              Channels
            </a>
            <a className="footer-links" href="/case-studies">
              Case studies
            </a>
            <a className="footer-links" href="/faqs">
              FAQs
            </a>
            <a className="footer-links" href="/terms-of-use">
              Terms of use
            </a>
            <a className="footer-links" href="/privacy-policy">
              Privacy policy
            </a>
            <a className="footer-links" href="/pricing">
              Pricing
            </a>
            <a className="footer-links" href="/sitemap">
              Sitemap
            </a>
            <a className="footer-links" href="/refer-and-earn">
              Refer &amp; earn
            </a>
            <a className="footer-links" href="/become-a-problem-setter">
              Become a problem setter
            </a>
            <a className="footer-links" href="/blog">
              Blog
            </a>
          </div>
